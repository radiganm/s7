...
static s7_pointer s7_dl_sigwaitinfo(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "sigwaitinfo", 1, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_c_pointer(s7_car(arg)))
    s7_dl_sigwaitinfo_1 = (siginfo_t*)s7_c_pointer(s7_car(arg));
  else return(s7_wrong_type_arg_error(sc, "sigwaitinfo", 2, s7_car(arg), "c_pointer"));
...
static s7_pointer s7_dl_waitid(s7_scheme *sc, s7_pointer args)
{
  ...
  else return(s7_wrong_type_arg_error(sc, "waitid", 3, s7_car(arg), "c_pointer"));
  arg = s7_cdr(arg);
  if (s7_is_integer(s7_car(arg)))
...
{
  s7_pointer cur_env;
  s7_pointer pl_st, pl_ts, pcl_t, pl_ix, pl_ixi, pl_ixxi, pl_xis, pcl_ixsi, pl_ixiix, pl_xi, pcl_di, pl_iixiixi, pl_iiixi, pl_iisi, pl_iixi, pl_iix, pl_sx, pcl_xs, pl_xssx, pcl_x, pl_xt, pl_txs, pl_tx, pl_ds, pl_isxi, pl_issi, pl_isi, pcl_is, pl_si, pl_isx, pl_sisi, pl_sis, pcl_i, pl_it, pl_ti, pcl_xxi, pl_xxxi, pl_sssi, pl_ssi, pl_ssix, pcl_s;
  {
  ...
  s7_define(sc, cur_env,
            ...
            s7_make_typed_function(sc, "sigwaitinfo", s7_dl_sigwaitinfo, 2, 0, false, "int sigwaitinfo(sigset_t* siginfo_t*)", pl_ix));
